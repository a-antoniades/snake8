    ...
    def collision(self):
        if (self.snake_position[0][0] == 0 or
            ...
            for i in range(100000):
                file = \
                    ('/Users/antonis/Desktop/PycharmProjects/deep_snake/snake_data/df_snake_test/snake_game_%d.csv' % i)
...
# for i in {1..1500}; do python3 /Users/antonis/Desktop/PycharmProjects/deep_snake/snake_10.py; done
